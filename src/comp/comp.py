...
print("Starts with D:")
a = [human.name for human in humans if human.name[0] == "d".upper()]
print(a)
...
c = [
    human.name
    for human in humans
    if human.name[0] >= "c".upper() and human.name[0] <= "g".upper()
]
print(c)
...
# test wants exactly "name-age" not "name - age"
...
# math.isqrt(x) returns rounded value, test wants exact
# square root is y^2 = x so exponential power in python ** 0.5 thanks google
